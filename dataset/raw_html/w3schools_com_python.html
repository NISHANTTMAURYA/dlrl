...
<a class="w3-btn w3-margin-bottom" href="python_intro.asp" style="font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">Start learning Python now &raquo;</a>
</div>
...
<div style="display: flex; align-items: center; gap: 8px; margin-top: -8px;margin-bottom:-5px">
  ...
  <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-pythondefaultsignup" style="text-decoration:none"  title="Create a free account to track your progress">
  <span style="font-size: 16px;" title="Create a free account to track your progress">&#x1F3C1;</span></a>
</div>
<p><strong>Tip:</strong> <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-pythondefaultsignup" title="Create a free account to track your progress and earn XP">Sign in</a> to track your progress - it's free.</p> 
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_default">Try it Yourself &raquo;</a>
</div>
...
<div id="exercisecontainer" src="xrcise_variables.js"></div>
<p><a class="w3-btn w3-margin-bottom ws-green" href="python_exercises.asp" style="border-radius:5px;font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">See all Python Exercises</a></p>
<hr>
...
<p><a href="python_examples.asp" class="w3-button w3-light-grey w3-round">See All Python Examples</a></p>
<hr>

<h2>Python Quiz</h2>
<p>Test your Python skills with a quiz.</p>
<p><a href="python_quiz.asp" class="w3-button w3-blue w3-round">Python Quiz</a></p>
<hr>
...
<div class="ref-grid">
  ...
  <a href="python_reference.asp" class="ref-box">Reference Overview</a>
  <a href="python_ref_functions.asp" class="ref-box">Built-in Functions</a>
  <a href="python_ref_string.asp" class="ref-box">String Methods</a>
  <a href="python_ref_list.asp" class="ref-box">List / Array Methods</a>
  <a href="python_ref_dictionary.asp" class="ref-box">Dictionary Methods</a>
  <a href="python_ref_tuple.asp" class="ref-box">Tuple Methods</a>
  <a href="python_ref_set.asp" class="ref-box">Set Methods</a>
  <a href="python_ref_file.asp" class="ref-box">File Methods</a>
  <a href="python_ref_keywords.asp" class="ref-box">Python Keywords</a>
  <a href="python_ref_exceptions.asp" class="ref-box">Python Exceptions</a>
  <a href="python_ref_glossary.asp" class="ref-box">Python Glossary</a>

  <a href="module_random.asp" class="ref-box">Random Module</a>
  <a href="module_requests.asp" class="ref-box">Requests Module</a>
  <a href="module_statistics.asp" class="ref-box">Statistics Module</a>
  <a href="module_math.asp" class="ref-box">Math Module</a>
  <a href="module_cmath.asp" class="ref-box">CMath Module</a>
